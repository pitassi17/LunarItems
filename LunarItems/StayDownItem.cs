            ...
            rules.Add("mdlCaptain", new ItemDisplayRule[]
{
        ...
        {
            orig(self);
            if (!self.gameObject.GetComponent<StayDownBehavior>() && self.inventory.GetItemCount(index) != 0) self.gameObject.AddComponent<StayDownBehavior>();
        }
    }
}