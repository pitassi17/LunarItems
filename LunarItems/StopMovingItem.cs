...
namespace CustomLunarStuff
{
    internal class StopMovingItem
    {
        ...
        {
            LanguageAPI.Add("SCISSORS_NAME_TOKEN", "Stop Moving");
            ...
            rules.Add("mdlCaptain", new ItemDisplayRule[]
{
        ...
        {
            orig(self);
            if (!self.gameObject.GetComponent<StopMovingBehavior>() && self.inventory.GetItemCount(index) != 0) self.gameObject.AddComponent<StopMovingBehavior>();
        }
    }
}